      ...
      <div className="customer-account-login-shell">
        <header className="customer-account-login-header">
          ...
          <div className="customer-account-login-title">
            ...
            <p>
              الدخول إلى مشاريعك ومشترياتك من حساب واحد.
            </p>
          </div>
        </header>
        ...
        <section className="customer-account-card">
          ...
          <p>
            {step === "email"
              ? "أدخل البريد الإلكتروني المسجل في مشروعك أو المستخدم عند الشراء."
          ...
          <div className="customer-account-note">
            ...
            <p>
              استخدم البريد الإلكتروني نفسه الذي سجلته عند تقديم مشروع البناء أو عند إتمام الشراء، حتى تظهر مشاريعك ومشترياتك تلقائيًا.
            </p>
          </div>
        </section>
